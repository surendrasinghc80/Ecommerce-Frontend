      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 pb-10">
        {products.map((product) => (
          <Card key={product.id} className="overflow-hidden hover:shadow-lg transition-shadow">
            <div className="w-full h-40 md:h-48 relative group mb-2 md:mb-4 cursor-pointer">
              <Image
              ...
              <div className="absolute opacity-0 right-0 translate-x-10 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300 mr-2">
                <button
                  ...
                  className="bg-white p-1 rounded-full shadow mr-1"
                >
                  <Eye className="h-5 w-5 md:h-6 md:w-6 p-0.5" />
                </button>
                <button className="bg-white p-1 rounded-full shadow">
                  <Heart className="h-5 w-5 md:h-6 md:w-6 p-0.5 text-red-600 fill-red-600" />
                </button>
              </div>
            </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center mb-4">
                        ...
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            className={`w-4 h-4 ${i < selectedProduct.rating
                              ? "fill-yellow-400 text-yellow-400"
                              : "fill-gray-200 text-gray-200"
                              }`}
                          />
